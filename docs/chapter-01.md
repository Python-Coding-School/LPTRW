...
![Running code in the interpreter (immediate mode)](../images/01-01-python-interpreter.png "Running code in the interpreter (immediate mode)")
...
![Running code from a file (script mode)](../images/01-02-running-a-script.png "Running code from a file (script mode)")
